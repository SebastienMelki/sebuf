...
var file_proto_sebuf_http_errors_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_sebuf_http_errors_proto_goTypes = []any{
	(*ValidationError)(nil), // 0: sebuf.http.ValidationError
	(*FieldViolation)(nil),  // 1: sebuf.http.FieldViolation
}
var file_proto_sebuf_http_errors_proto_depIdxs = []int32{
	1, // 0: sebuf.http.ValidationError.violations:type_name -> sebuf.http.FieldViolation
