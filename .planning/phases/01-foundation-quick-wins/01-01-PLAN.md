...
**Step 6:** Close GitHub issue #105 (the net/url bug) with a comment referencing this fix:
```bash
...
6. Issue #105 shows state CLOSED on GitHub (closed by Task 1 after net/url fix)
